{
  ...
  "rules": {
    ...
    "unicorn/explicit-length-check": [ 1, { "non-zero": "not-equal" } ],
    "unicorn/filename-case": [ 0, { "case": "kebabCase" } ],
    ...
    "node/no-missing-require": [ 2, { "tryExtensions": [".js", ".json", ".ts" ] } ],
    ...
    "node/exports-style": [ 2, "exports", { "allowBatchAssign": true } ],
